...
export const TOOLS_APP_DEFINITIONS: PresentationAppDefinition[] = [
  ...
  {
    id: "studio-bridge",
    title: "Talend Studio Bridge",
    description: "Panel de control del bridge de Talend Studio con diagnóstico y herramientas.",
    resourceUri: "ui://talend/studio-bridge.html",
    launcherToolName: "talend_app_studio_bridge",
    launchMessage: "Abriendo el panel del Studio Bridge.",
    actions: [
      createNoInputAction("Bridge ping", TOOL_NAMES.BRIDGE.PING, "Verifica si el bridge está disponible."),
      createNoInputAction("Bridge capabilities", "talend_bridge_capabilities", "Obtiene las capacidades del plugin bridge."),
      createNoInputAction("Audit environment", TOOL_NAMES.BRIDGE.AUDIT_ENVIRONMENT, "Audita el entorno de Talend Studio."),
      createNoInputAction("Workbench state", TOOL_NAMES.BRIDGE.WORKBENCH_STATE, "Obtiene el estado actual del workbench."),
      createNoInputAction("Active job model", "talend_bridge_active_job_model", "Obtiene el modelo del job activo."),
      createNoInputAction("Selection", "talend_bridge_selection", "Obtiene la selección actual en el workbench."),
      createNoInputAction("Views", "talend_bridge_views", "Lista las vistas abiertas."),
      createNoInputAction("Workspace state", TOOL_NAMES.BRIDGE.WORKSPACE_STATE, "Obtiene el estado del workspace."),
      createNoInputAction("Problems markers", TOOL_NAMES.BRIDGE.PROBLEMS_MARKERS, "Obtiene los markers de problemas."),
      createNoInputAction("Save active editor", TOOL_NAMES.BRIDGE.SAVE_ACTIVE_EDITOR, "Guarda el editor activo."),
      createNoInputAction("Save all editors", TOOL_NAMES.BRIDGE.SAVE_ALL, "Guarda todos los editores."),
      createNoInputAction("Refresh workspace", "talend_bridge_refresh_workspace", "Refresca el workspace."),
    ],
  },
];
